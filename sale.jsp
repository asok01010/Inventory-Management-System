...
<style>
  ...
  form#saleForm input[type="text"],
  form#saleForm input[type="number"],
  form#saleForm button {
    width: 100%;
    padding: 10px;
    margin-bottom: 15px;
...
<div class="container">
  <h1>Sale </h1>
  <!-- Sale form -->
  <form id="saleForm" action="SaleServlet" method="post">
