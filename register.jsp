...
<c:if test="${not empty sessionScope.registrationSuccess}">
  <p>${sessionScope.registrationSuccess}</p>
...
<c:if test="${not empty sessionScope.registrationError}">
  <p>${sessionScope.registrationError}</p>
  <%-- Remove the session attribute after displaying the message --%>
...
<div class="wrapper">
  ...
  <h2>Registration</h2>
  <form action="RegistrationServlet" method="post"> <!-- Corrected action attribute -->
    <div class="input-box">
      <input type="text" name="name" placeholder="Enter your name" required> <!-- Corrected input type -->
    </div>
    <div class="input-box">
    ...
    <div class="input-box">
      <input type="password" name="confirm_password" placeholder="Confirm password" required> <!-- Added input for confirm password -->
    </div>
    ...
    <div class="button input-box" >
      <button type="submit" class="btn btn-secondary s-btn">Register</button>
