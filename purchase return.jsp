...
<style>
  ...
  form#purchaseReturnForm label {
    display: block;
    margin-bottom: 5px;
  }

  form#purchaseReturnForm input[type="text"],
  form#purchaseReturnForm input[type="number"],
  form#purchaseReturnForm input[type="date"],
  form#purchaseReturnForm button {
    width: 100%;
    padding: 10px;
    margin-bottom: 15px;
  ...
  form#purchaseReturnForm button:hover {
...
<div class="container">
  ...
  <!-- Sale form -->
  <form id="purchaseReturnForm" action="PurchaseReturnServlet" method="post">
